...
async def publish(data, message_id) -> None:
    ...
    async with connection:
        ...
        queue = await channel.declare_queue(settings.FROM_YANDEX_GPT_QUEUE, auto_delete=True)
...
async def consume() -> None:
    ...
    queue = await channel.declare_queue(settings.TO_YANDEX_GPT_QUEUE, auto_delete=True)
